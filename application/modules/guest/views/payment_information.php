...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/core/css/custom.css?cache=546">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-7">
                            <h4>
                               <?php
                               $firma = $invoice->client->custom['Firma'] ?? '';
                               if (!empty($firma)) {
                                   echo '<b>' . htmlspecialchars($firma) . '</b><br>' 
                                      . lang($invoice->client_title) . ' ' 
                                      . htmlspecialchars($invoice->client_name) . ' ' 
                                      . htmlspecialchars($invoice->client_surname) . '<br>';
                               } else {
                                   echo '<b>' . lang($invoice->client_title) . ' ' 
                                      . htmlspecialchars($invoice->client_name) . ' ' 
                                      . htmlspecialchars($invoice->client_surname) . '</b>';
                               }
                               ?>
                            </h4>
