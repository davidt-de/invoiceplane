...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/core/css/custom-pdf.css?cachebust=1243347353">
...
<?php
$count = count($items);
$height = max(0, 180 - ($count * 27)); // Beispiel: weniger Posten = mehr Platz
if ($height > 0) {
